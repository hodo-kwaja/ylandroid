...
*/
    ...
    private void createBigView() {
        ...
        String SS="급행";
        Log.d("넘스텝","넘스텝"+numStep_);
        Log.d("역이름","역이름"+staitonName_tt[numStep_-1]);
